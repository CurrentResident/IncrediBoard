...
typedef boost::fusion::vector<KeyESCAPE, KeyNONE, KeyF1,   KeyF2,   KeyF3,   KeyF4,    KeyF5,   KeyF6,   KeyF7,    KeyF8,   KeyF9,    KeyF10,        KeyF11,         KeyF12,       KeyPRTSCR, KeySCRLK, KeyPAUSE>     Row0;
...
typedef boost::fusion::vector<KeyCAPS,   KeyA,    KeyS,    KeyD,    KeyF,    KeyG,     KeyNONE, KeyH,    KeyJ,     KeyK,    KeyL,     KeySEMICOLON,  KeyQUOTE,       KeyENTER,     KeyNONE,   KeyNONE,  KeyNONE>      Row3;
typedef boost::fusion::vector<KeyLSHIFT, KeyZ,    KeyX,    KeyC,    KeyV,    KeyB,     KeyNONE, KeyNONE, KeyN,     KeyM,    KeyCOMMA, KeyPERIOD,     KeySLASH,       KeyRSHIFT,    KeyNONE,   KeyUP,    KeyNONE>      Row4;
