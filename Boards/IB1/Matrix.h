...
typedef boost::fusion::vector<KeyCAPS,   KeyA,    KeyS,    KeyD,    KeyF,    KeyG,     KeyH,    KeyNONE, KeyJ,     KeyK,    KeyL,     KeySEMICOLON,  KeyQUOTE,       KeyENTER,     KeyNONE,   KeyNONE,  KeyNONE,      KeyKP_4,     KeyKP_5,     KeyKP_6,        KeyNONE>     Row3;
typedef boost::fusion::vector<KeyLSHIFT, KeyZ,    KeyX,    KeyC,    KeyV,    KeyB,     KeyN,    KeyNONE, KeyNONE,  KeyM,    KeyCOMMA, KeyPERIOD,     KeySLASH,       KeyRSHIFT,    KeyNONE,   KeyUP,    KeyNONE,      KeyKP_1,     KeyKP_2,     KeyKP_3,        KeyKP_ENTER> Row4;
typedef boost::fusion::vector<KeyLCTRL,  KeyLGUI, KeyLALT, KeyNONE, KeyNONE, KeySPACE, KeyNONE, KeyNONE, KeyNONE,  KeyNONE, KeyRALT,  KeyRGUI,       KeyNONE,        KeyRCTRL,     KeyLEFT,   KeyDOWN,  KeyRIGHT,     KeyNONE,     KeyKP_0,     KeyKP_PERIOD,   KeyNONE>     Row5;
